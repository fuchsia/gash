...
// 2025_4_4: These are constructors we guarantee as part of the IDL, no matter the
// host.
// 
// NB there is no guarantee they have an equivalent on the command line; 
...
//
// Currently these override any constructor provided by the type system.
//
// The host also adds some - including `
//  // Objects - kinda...
//   Buffer,
//   Uint8Array 
//   // Namespaces
...
const flyingMonkeys = {
    ...
    '%String.prototype%.hash(...)': function(seed) {
        return murmurhash3_32( Buffer.from( this ), seed )
    },
...
evaluate( bindingText, globalDefaults = {})
    {
        ...
        const defaults = Object.assign( 
            ...
            // 2025_4_4: These are globals provided by the type system. 
            casts,
            // 2025_4_4: More globals provided by the type system.
            constructors,
            // 2025_4_4:  These are the constructors we grandfather; there are probably things
            // like `String`, `Boolean`, etc.. that we should always provide. RegExp, Date, etc...
...
Idl {
    ...
    // 2025_4_4: Dead wood check:
    set constructorGlobalDefaults( value ) {
        throw new Error( "Set constructorGlobalDefaults" );
    }
    get constructorGlobalDefaults( ) {
        return {};
    }
    ...
    validateModule( moduleOrFunction ) {
        return !!getImports( this.#binding.imports, toModule( moduleOrFunction ) );
    }
    ...
    // 2025_2_15: BlankScripltetNode needs this.
    isValidGashUsage() {
        const usesGash = this.#binding.imports.includes( 'gash' );
        if ( !usesGash )
            return true;
        if ( this.#binding.isWith ) 
            return false;
        return isCall( this.#binding.astNode, { await: true }  );
    }
};
