...
const initialTypeList = [
    ...
    */
    ...
    new TypeRegistration({
        ...
        /* Should be flying monkeys. e.g. `Date.fromNumber()`, etc.. */
        casts: {
...
// 2025_4_4: These become globals in the IDL environment.
// 2025_4_4: FIXME: we should be able to create flying monkeys.
// 2025_4_4: FIXME: most of these are historical, undocument, and redundent 
// and should attract obbrium. 
export const 
casts = (function () {
        const casts = {};
...
// 2025_4_4: More globals for type names. Others could be here; E.g. `new File`
// (NB Check the host doesn't provide this and migrate to here.)
//
// Should we do this an an `idl`: entry or `jsConstructor` or something in the type definition?
// Should we synethise a constructor (fromString, fromNumber, etc...?) or add a flying monkey
// onto the type for that. So we have `Date.fromString()` (or `Date.parse`?) and ban `new`? 
export const 
constructors = {
    Date,
};
