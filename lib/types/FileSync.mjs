...
import {resolve as Path_resolve,relative as Path_relative,parse as Path_parse} from "node:path";
...
FileSync
{
    ...
    // These are the properties from `path.parse()` might as well keep them.
    #root;
    #dir;
    #base;
    #ext;
    ...
    #webkitRelativePath;   //< string: The path we were constructed with.
    #fullPath;             //< string: resolved pathl
    ...
    constructor( filename, cwd = ".", stat, mimetype, getContentAsBuffer )
        {
            ...
            const {ext,name,base,dir,root} = Path_parse( this.#fullPath );
            this.#ext = ext;
            this.#name = name;
            this.#dir = dir;
            this.#root = root;
            ...
            this.#type = mimetype ?? lookupMimeTypeFromExtension ( this.#ext );
    ...
    get name() { return this.#base }     // This requires the extension. Ugh!
    ...
    get extlessName() { return this.#name }  // Ugh, whatelse can we call it.
    get dir() { return this.#dir } // Parent?
