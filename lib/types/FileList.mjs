...
function*
FileList_fromStringsAndFiles( filespecsAndFiles = [], {extensions,exclude,cwd,recurse,dirs=false,files = true,minDate} = {} )  
    {
        ...
        for ( const filename of glob( filespecs, { recurse, glob: subdirGlob, exclude, cwd: cwdString , return: { dirs, files }, minDate } ) ) {
