...
Binding {
    ...
    #globalReferences;        //< Map: Global identifiers as keys; values are a `Set` of AST nodes where they are referenced.
                              //  This includes imports.
    #isWith;                  //< bool: did this use the new style declaration of `with()` or the old style that omits it?    
    ...
    // Ideally private. But...
    constructor({importReferences,globalReferences,imports,args,typeAssertion,inlineOptions,isVoid,nonWith = false}) {
        this.#ast = args;
