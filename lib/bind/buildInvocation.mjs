...
realise( value, parameters )
    {
        ...
        // 2025_3_21: null objects (such as returned via node's sqlite) don't have
        // a constructor.
        const to = value[realiseTo] || valueConstructor?.[realiseTo]; 
        ...
        if ( valueConstructor?.name === 'Integer' )
